                        ...
                        <table role="presentation" border="0" cellpadding="0" cellspacing="0" width="100%">
                            <tr>
                                <td class="logo" style="text-align: left;">
                                    <h3>Name : {{ $data->order->fname ." " .$data->order->lname}}</h3>
                                    <h4>Address : {{ $data->order->address}}</h4>
                                    <h4>Phone : {{ $data->order->phone}}</h4>
                                </td>
                            </tr>
                        </table>
                    </td>
                        ...
                        <tr style="border-bottom: 1px solid rgba(0,0,0,.05);">
                            <td valign="middle" width="80%" style="text-align:left; padding: 0 2.5em;">
                                <div class="product-entry">
                                    <img src="assets\images\book\{{ $data->book->image }}" alt="" style="width: 100px; max-width: 600px; height: auto; margin-bottom: 20px; display: block;">
                                    <div class="text">
                                        <h3>{{ $data->book->title }}</h3>
                                        <span>{{ $data->book->author_name }}</span>
                                        <p>{{ $data->book->description }}</p>
                                    </div>
                                </div>
                            </td>
                            <td valign="middle" width="20%" style="text-align:left; padding: 0 2.5em;">
                                <span class="price" style="color: #000; font-size: 20px;">{{ $data->total_price }} ENG</span>
                            </td>
                        </tr>
