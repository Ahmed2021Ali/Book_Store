        ...
        <div class="section-container row">
            <div class="col-md-6 col-lg-3 mb-5 mb-lg-0">
                <div class="footer__logo">
                    <img class="w-100" src="{{ url('/assets/images/logo.jpg') }}" alt="">
                </div>
            ...
            <div class="col-md-6 col-lg-3 px-md-4 mb-5 mb-lg-0">
                ...
                <div class="footer__list list-unstyled p-0">
                    <li><a class="footer__link text-decoration-none d-inline-block text-gray py-1" href="{{ route('about_us') }}">من
                            نحن</a></li>
                    <li><a class="footer__link text-decoration-none d-inline-block text-gray py-1"
                            href="{{ route('contact_us') }}">تواصل معنا</a></li>
                    <li><a class="footer__link text-decoration-none d-inline-block text-gray py-1"
                            href="{{ route('refund_policy') }}">سياسة الخصوصية</a></li>
                    <li><a class="footer__link text-decoration-none d-inline-block text-gray py-1"
                            href="{{ route('refund_policy') }}">سياسة الاستبدال و
                            الاسترجاع</a></li>
                    <li><a class="footer__link text-decoration-none d-inline-block text-gray py-1"
                            href="{{ route('order.search.page') }}">تتبع طلبك</a></li>
                </div>
            </div>
            <div class="col-md-6 col-lg-3 px-md-4 mb-5 mb-lg-0">
                <div class="footer__list-title fw-bolder mb-1">
            ...
            <div class="col-md-6 col-lg-3 mb-5 mb-lg-0">
                <div>
                    ...
                    <div class="d-flex gap-3 mb-3">
                        ...
                        <div class="text-gray">eng.ahmed1419@gmail.com</div>
                    </div>
                </div>
                <div>
...
<script src="{{ url('assets/js/vendors/all.min.js') }}')}}"></script>
<script src="{{ url('assets/js/vendors/bootstrap.bundle.min.js') }}"></script>
<script src="{{ url('assets/js/vendors/jquery-3.7.0.js') }}"></script>
